...
class TermuxCommandsPage extends StatelessWidget {
  ...
  final List<Map<String, String>> comandos = const [
    {
      ...
      "descripcion": "Actualiza la lista de paquetes e instala actualizaciones."
    },
    {
      "comando": "pkg install git",
      "descripcion": "Instala Git para clonar repositorios desde GitHub u otras fuentes."
    },
    {
      "comando": "termux-setup-storage",
      "descripcion": "Permite el acceso al almacenamiento interno del dispositivo."
    },
    {
    ...
    },
    {
      ...
      "descripcion": "Instala el editor de texto Nano para editar archivos desde Termux."
    },
    {
    ...
    },
    {
      ...
      "descripcion": "Herramienta para descargar archivos desde internet vía terminal."
    },
    {
      "comando": "pkg install openssh",
      "descripcion": "Instala herramientas SSH para conexiones seguras a servidores remotos."
    },
    {
  ...
  void copiarAlPortapapeles(BuildContext context, String comando) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text("📋 Copiado: $comando")),
    );
  }
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            ...
            child: ListTile(
              title: Text(cmd["comando"]!, style: const TextStyle(color: Colors.greenAccent, fontFamily: 'monospace')),
              subtitle: Padding(
                padding: const EdgeInsets.only(top: 4),
                child: Text(cmd["descripcion"]!, style: const TextStyle(color: Colors.white70)),
              ),
              trailing: IconButton(
