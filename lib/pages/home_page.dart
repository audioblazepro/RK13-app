...
class HomePage extends StatelessWidget {
  ...
  final List<RepoModel> repos = [
    RepoModel(
      name: "Hack-Tools",
      description: "Herramientas para auditorías de hacking + 234 tools",
      scriptFile: "hack-tools.sh",
      readmeAsset: "assets/readmes/hack-tools.md",
      githubUrl: "https://github.com/hacktoolspack/hack-tools.git",
    ),
    RepoModel(
      name: "BeEF",
